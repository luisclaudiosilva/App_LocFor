<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Escolher_Aluguel_Todos.aspx.cs" Inherits="AppLocForWeb.Escolher_Aluguel_Todos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="server">

   <asp:Panel runat="server" ID="Panel1" Height="453px" Width="969px">
    <h1 style="font-weight: bold; text-align:center; margin-top:10px; width:955px;">Sua busca encontrou: <asp:Label ID="lblResultado" runat="server"></asp:Label>Resultados!</h1>

    <asp:Panel runat="server" ID="pnlCadastro" CssClass="panelEscolherAluguel" Visible="true" Font-Size="Large" Height="319px" Width="969px" ScrollBars="Auto">
                 <asp:GridView ID="GridView1" CssClass="gridDisponivel" runat="server" GridLines="None" AutoGenerateColumns="False" DataKeyNames="codigoImovel" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="934px">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="negocioNome" HeaderText="Negócio" SortExpression="negocioNome" />
                 ...
                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Projeto_LocacaoConnectionStringAcer %>" SelectCommand="SELECT Imovel.codigoImovel, Bairro.nomeBairro, TipoImovel.nomeTipoImovel, Negocio.negocioNome, Quartos.quantidadeQuarto, situacaoImovel.tipoSituacao, Imovel.valorImovel FROM Bairro INNER JOIN Imovel ON Bairro.codigoBairro = Imovel.codigoBairro INNER JOIN TipoImovel ON Imovel.codigoTipoImovel = TipoImovel.codigoTipoImovel INNER JOIN Negocio ON Negocio.codigoNegocio = Imovel.codigoNegocio INNER JOIN Quartos ON Quartos.codigoQuarto = Imovel.codigoQuarto INNER JOIN situacaoImovel ON Imovel.codigoSituacao = situacaoImovel.codigoSituacao"></asp:SqlDataSource>
        
      </asp:Panel> 
    <asp:Panel runat="server" ID="PanelBotoes" Visible="true" Font-Size="Large" Width="723px" Height="40px" CssClass="botoes">  
