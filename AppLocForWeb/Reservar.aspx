...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <asp:Panel runat="server" ID="pnlCadastro" Visible="true" Font-Size="Large">
        <p style="font-weight: bold; text-align: center; width: 857px;">Com a LOCFOR você pode agendar um aluguel futuro.</p>

                 <p style="font-weight: bold; text-align: center;">
                     &nbsp;</p>

                 <asp:GridView ID="GridView1" runat="server" GridLines="None" AutoGenerateColumns="False" DataKeyNames="codigoImovel" DataSourceID="SqlDataSource2" CellPadding="4" ForeColor="#333333" Width="922px">
