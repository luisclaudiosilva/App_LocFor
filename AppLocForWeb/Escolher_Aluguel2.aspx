<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Escolher_Aluguel2.aspx.cs" Inherits="AppLocForWeb.Escolher_Aluguel2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphContent" runat="server">
   ...
   <asp:Panel runat="server" ID="pnlCadastro" Visible="true" Font-Size="Large" Width="728px">
        <h1 style="font-weight: bold">Alugar</h1>
                 ...
                 <asp:GridView ID="GridView1" runat="server" GridLines="None" AutoGenerateColumns="False" DataKeyNames="codigoImovel" DataSourceID="SqlDataSource2" CellPadding="4" ForeColor="#333333" Width="664px">
...
&nbsp;<asp:TextBox ID="txtSituacao" runat="server"></asp:TextBox>
        ...
        <br />
        <asp:Button ID="Inicio" runat="server" CssClass="btnAdd btn" Text="Inicio" />
        &nbsp;
        <asp:Button ID="Voltar" runat="server" CssClass="btnAdd btn" Text="Voltar" />
        &nbsp;
         <asp:Button ID="btnEscolherAluguel" runat="server" Text="Seguinte" CssClass="btnAdd btn"/>
