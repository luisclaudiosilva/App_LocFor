...
<asp:Panel runat="server" ID="pnlCadastro" Visible="True" Height="386px" Width="791px">
        ...
        <asp:Panel ID="Panel2" runat="server" Height="301px" Width="264px" BorderStyle="None" BackColor="#FEF8F1">
           ...
           <br /><br />
            ...
            <asp:Button ID="btnVoltar" runat="server" CssClass="btnAdd btn2" Height="46px" Text="Inicio" Width="102px" OnClick="btnVoltar_Click"/>
                
                <br />
                
                
                    <asp:Label ID="lblMensagem" runat="server" Width="181px"></asp:Label>
        ...
        <asp:Panel ID="Panel1" runat="server" Height="301px" Width="264px" BackColor="#FEF8F1" Visible="True">
            ...
            <br></br>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnCadastrar" runat="server" CssClass="btnAdd btn2" Height="46px" Text="Cadastrar" Width="196px" OnClick="btnCadastrar_Click1"/>
